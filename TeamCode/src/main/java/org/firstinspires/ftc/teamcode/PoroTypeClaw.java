    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()) {
            ...
            */
            ...
            innerPos = gamepad1.right_bumper ? 0 : innerPos;
            innerPos = gamepad1.left_bumper ? .5 : innerPos;
            outerPos = gamepad1.right_bumper ? .5 : outerPos;
            outerPos = gamepad1.left_bumper ? 0 : outerPos;
